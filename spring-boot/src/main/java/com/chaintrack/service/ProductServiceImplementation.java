...
import com.chaintrack.modal.Category;
import com.chaintrack.modal.Product;
import com.chaintrack.repository.CategoryRepository;
import com.chaintrack.repository.ProductRepository;
import com.chaintrack.request.CreateProductRequest;
import com.chaintrack.user.domain.ProductSubCategory;
...
public class ProductServiceImplementation implements ProductService {
	...
	public String deleteProduct(Long productId) throws ProductException {
		...
		System.out.println("delete product "+product.getProductId()+" - "+productId);
